...
public class ProShield extends JavaPlugin {
    ...
    /** Public API used by Admin GUI + /proshield reload */
    ...
    /** Non-destructive: set defaults for 1.2.4 if missing */
    private void migrateConfigTo124() {
        ...
        // Spawn guard (also used by SpawnGuardListener)
        ...
        // Minimal GUI defaults (your full layout still lives in config.yml)
