...
public class GUIManager {
    ...
    public void openMain(Player player) {
        ...
        inv.setItem(10, createItem(Material.GRASS_BLOCK, ChatColor.GREEN + "Claim Chunk", "Claim your current land"));
        inv.setItem(11, createItem(Material.BARRIER, ChatColor.RED + "Unclaim Chunk", "Remove your claim"));
        inv.setItem(12, createItem(Material.BOOK, ChatColor.YELLOW + "Claim Info", "View claim details"));
        inv.setItem(13, createItem(Material.PLAYER_HEAD, ChatColor.GOLD + "Trust Menu", "Manage trusted players"));
        inv.setItem(14, createItem(Material.IRON_SWORD, ChatColor.RED + "Flags", "Toggle claim flags"));
        inv.setItem(15, createItem(Material.NAME_TAG, ChatColor.AQUA + "Roles", "Manage claim roles"));
        inv.setItem(16, createItem(Material.ENDER_PEARL, ChatColor.LIGHT_PURPLE + "Transfer Claim", "Transfer ownership"));
    ...
    public void openAdminMain(Player player) {
        ...
        inv.setItem(10, createItem(Material.COMPASS, ChatColor.AQUA + "Teleport to Claim", "Admin-only teleport"));
        inv.setItem(11, createItem(Material.TNT, ChatColor.RED + "Force Unclaim", "Remove any claim"));
        inv.setItem(12, createItem(Material.CHEST, ChatColor.GOLD + "Manage Flags", "Override claim flags"));
        inv.setItem(13, createItem(Material.HOPPER, ChatColor.YELLOW + "Toggle Keep-Items", "Force keep-drops"));
        inv.setItem(14, createItem(Material.BOOK, ChatColor.DARK_PURPLE + "Wilderness Tools", "Manage wilderness settings"));

        // ✅ Admins also get access to player tools
        inv.setItem(15, createItem(Material.GRASS_BLOCK, ChatColor.GREEN + "Claim Chunk", "Claim your own land"));
        inv.setItem(16, createItem(Material.BARRIER, ChatColor.RED + "Unclaim Chunk", "Unclaim land"));
    ...
    public void openFlagsMenu(Player player) {
        ...
        // ✅ Back button
        inv.setItem(26, createItem(Material.ARROW, ChatColor.GRAY + "Back", "Return to main menu"));
    ...
    public void openTransferMenu(Player player) {
        ...
        // ✅ Back button
        inv.setItem(8, createItem(Material.ARROW, ChatColor.GRAY + "Back", "Return to main menu"));
