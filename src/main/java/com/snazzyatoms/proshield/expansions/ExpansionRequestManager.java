...
public class ExpansionRequest {
    ...
    // ✅ Middle constructor used by manager
    ...
    public ExpansionRequest(UUID requester, int amount, Instant timestamp, Status status,
                            String denialReason, UUID reviewedBy) {
